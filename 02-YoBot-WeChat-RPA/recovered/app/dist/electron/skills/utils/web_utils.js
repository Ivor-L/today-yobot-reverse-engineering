...
export async function extractReadableContent(params) {
    ...
    try {
        ...
        // Set base URI if possible (Linkedom might not support it directly on document object like JSDOM)
        // But Linkedom's parseHTML returns a Window object-like structure where document is available.
        // We can try to set it if property exists or just ignore.
        try {
            // @ts-ignore
        ...
        // Convert Readability's HTML content to Markdown
