...
const _hoisted_1 = { class: "action-body" }
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createElementVNode("div", _hoisted_2, [
      _cache[1] || (_cache[1] = _createElementVNode("span", { class: "field-label" }, "拉入群", -1)),
      _createVNode(_component_el_select, {
        "model-value": __props.modelValue.targetGroupName,
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event: any) => (update('targetGroupName', $event))),
        placeholder: "选择目标群（仅已存在的群）",
        filterable: "",
        class: "field-control"
      }, {
        default: _withCtx(() => [
          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(__props.dataSources.groups, (g) => {
