...
export const DEFAULT_MACOS_APP_NAME = 'YoBot-Recovered';
export const DEFAULT_MACOS_APP_ID = 'local.yobot.recovered';
export const LEGACY_AGENT_DIRECTORY = '.yobot-recovered-legacy';
