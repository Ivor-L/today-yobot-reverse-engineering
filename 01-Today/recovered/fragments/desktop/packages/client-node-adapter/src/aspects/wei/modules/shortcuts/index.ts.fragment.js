// Compiled fragment from ../../packages/client-node-adapter/src/aspects/wei/modules/shortcuts/index.ts.
...
], ShortcutsWebService.prototype, "shell", void 0);
ShortcutsWebService = __decorate([
    logCalls(),
    injectable()
], ShortcutsWebService);
